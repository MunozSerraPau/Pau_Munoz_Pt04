...
<body>
    <?php session_start(); $nomUsuari = $_SESSION['usuari']; echo $nomUsuari ?>
        ...
        <div class="login-form-container">
            <form <?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>, method="POST" class="row g-3 login-form">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="nomCampio" value="<?php echo $champ['name']; ?>">
                </div>
                <div class="col-12">
                ...
                <div class="col-md-6"> 
                    ...
                    <input type="text" class="form-control" name="resource" value="<?php echo $champ['resource']; ?>">
                </div>
                <div class="col-md-6">
